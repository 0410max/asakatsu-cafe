...
<section class="feature" id="feature">
    ...
    <div class="feature__content">
        ...
        <div class="feature__content__text">
            <h3 class="feature__content__text__title">
                毎朝5:30~7:30まで朝活
            </h3>
            <p class="feature__content__text__description">
        ...
        <div class="slider-item">
            <div class="action__content">
                ...
                <div class="action__content__right">
                    ...
                    <p class="action__content__right__bottom">
...
<section class="flow" id="flow">
    ...
    <div class="flow__content">
        ...
        <div class="flow__content__right">
            ...
            <p class="flow__content__right__bottom">
    ...
    <div class="thought__wrapper">
        ...
        <div class="thought__bottom">
            ...
            <div class="thought__bottom__left">
                ...
                <p class="thought__bottom__left__bottom">
                    私は一昨年までずっと夜型でした。<br>
    ...
    <div class="faq__content">
        ...
        <div class="faq__content__a">
            <div class="faq__content__a__wrapper">
                ...
                <p class="faq__content__a__right">
